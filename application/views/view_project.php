		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					...
					<div class="card-tools">
						<a class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_task" href="<?php echo base_url("user/manage_task?pid=".$id);?>"><i class="fa fa-plus"></i> Task Baru</a>
					</div>
				<?php endif; ?>
				</div>
